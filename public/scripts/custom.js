        ...
        if(locationBut.length){
            ...
            if (typeof(locationSupport) != 'undefined' && locationSupport != null){
                ...
                if ("geolocation" in navigator){
                    locationSupport.innerHTML = 'دستگاه و مرورگر شما از موقعیت جغرافیایی <strong class="color-green2-dark">پشتیبانی میکند.</strong>';
                }else{
                    locationSupport.innerHTML = 'دستگاه و مرورگر شما از موقعیت جغرافیایی <strong class="color-red2-dark">پشتیبانی نمیکند.</strong>';
                }
            }
            function geoLocate() {
                ...
                function success(position) {
                    ...
                    var mapL1 = 'https://www.google.com/maps/embed/v1/view?key=AIzaSyBVWxC5WcAVYjCwGh6IqXsjKz26zyQOX2w&center=';
                    var mapL2 = latitude+',';
                    var mapL3 = longitude;
                ...
                function error() {locationCoordinates.textContent = 'امکان بازیابی موقعیت مکانی شما وجود ندارد';}
                if (!navigator.geolocation) {locationCoordinates.textContent = 'موقعیت جغرافیایی توسط مرورگر شما پشتیبانی نمیشود';}
