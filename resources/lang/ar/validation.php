...
return [
    ...
    */
    ...
    'custom' => [
        'currency' => [
            'required_if' => 'حقل العملة مطلوب للمستخدمين الذين ليسوا سائقين',
        ],
        'city' => [
            'required_if' => 'حقل المدينة مطلوب للسائقين',
        ],
        'car_type' => [
            'required_if' => 'حقل نوع السيارة مطلوب للسائقين',
        ],
    ],
    ...
    */
    ...
    'attributes'           => [
        ...
        'current_medical_issue' => 'المشكلة الطبية الحالية',
        'previous_conditions' => 'الشروط السابقة',
        'current_treatment' => 'العلاج الحالي',
        'consultation_type' => 'نوع الاستشارة',
        'scheduled_call_time' => 'وقت المكالمة المجدولة',
        'lan_id' => 'لغة',
